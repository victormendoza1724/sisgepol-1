 ...
 * @author remis
 */
@WebServlet(name = "ServletUsuarioActualizar", urlPatterns = {"/ServletUsuarioActualizar"})
public class ServletUsuarioActualizar extends HttpServlet {
    ...
    @Override
        protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            String result = usuario.actualizar(id_Tabla, nombres,apellidos,correo,contrasena,placa,rol,estado,estacion,grado);
